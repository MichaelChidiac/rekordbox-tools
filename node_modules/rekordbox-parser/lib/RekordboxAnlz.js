  ...
  var RekordboxAnlz = (function () {
    ...
    var PathTag = (RekordboxAnlz.PathTag = (function () {
      ...
      PathTag.prototype._read = function () {
        ...
        if (this.lenPath > 1) {
          this.path = KaitaiStream.bytesToStr(
            this._io.readBytes(this.lenPath - 2),
            'utf-16be'
          );
        }
      };
    ...
    var SongStructureTag = (RekordboxAnlz.SongStructureTag = (function () {
      ...
      SongStructureTag.prototype._read = function () {
        ...
        this._raw_body = KaitaiStream.processXorMany(
          this._raw__raw_body,
          this.isMasked ? this.mask : [0]
        );
      ...
      Object.defineProperty(SongStructureTag.prototype, 'c', {
        get: function () {
          if (this._m_c !== undefined) return this._m_c;
      ...
      Object.defineProperty(SongStructureTag.prototype, 'mask', {
        get: function () {
          if (this._m_mask !== undefined) return this._m_mask;
          this._m_mask = new Uint8Array([
            203 + this.c,
            225 + this.c,
            238 + this.c,
            250 + this.c,
      ...
      Object.defineProperty(SongStructureTag.prototype, 'rawMood', {
        get: function () {
          if (this._m_rawMood !== undefined) return this._m_rawMood;
      ...
      Object.defineProperty(SongStructureTag.prototype, 'isMasked', {
        get: function () {
          if (this._m_isMasked !== undefined) return this._m_isMasked;
      ...
      CueExtendedEntry.prototype._read = function () {
        ...
        if (!(KaitaiStream.byteArrayCompare(this.magic, [80, 67, 80, 50]) == 0)) {
          throw new KaitaiStream.ValidationNotEqualError(
            ...
            this.magic,
            this._io,
            '/types/cue_extended_entry/seq/0'
          );
        }
        this.lenHeader = this._io.readU4be();
        ...
        if (this.lenEntry > 43) {
          this.comment = KaitaiStream.bytesToStr(
            this._io.readBytes(this.lenComment),
            'utf-16be'
          );
        }
