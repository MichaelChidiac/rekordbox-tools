  ...
  var RekordboxPdb = (function () {
      ...
      DeviceSqlString.prototype._read = function () {
        ...
        switch (this.lengthAndKind) {
          ...
          case 144:
            ...
            break;
          default:
            this.body = new DeviceSqlShortAscii(
              this._io,
              this,
              this._root,
              this.lengthAndKind
    ...
    var PlaylistTreeRow = (RekordboxPdb.PlaylistTreeRow = (function () {
      ...
      Object.defineProperty(PlaylistTreeRow.prototype, 'isFolder', {
        get: function () {
          if (this._m_isFolder !== undefined) return this._m_isFolder;
    ...
    var DeviceSqlShortAscii = (RekordboxPdb.DeviceSqlShortAscii = (function () {
      ...
      Object.defineProperty(DeviceSqlShortAscii.prototype, 'length', {
        get: function () {
          if (this._m_length !== undefined) return this._m_length;
    ...
    var Page = (RekordboxPdb.Page = (function () {
      ...
      Object.defineProperty(Page.prototype, 'numRows', {
        get: function () {
          if (this._m_numRows !== undefined) return this._m_numRows;
          this._m_numRows =
            this.numRowsLarge > this.numRowsSmall && this.numRowsLarge != 8191
              ? this.numRowsLarge
              : this.numRowsSmall;
      ...
      Object.defineProperty(Page.prototype, 'numGroups', {
        get: function () {
          if (this._m_numGroups !== undefined) return this._m_numGroups;
      ...
      Object.defineProperty(Page.prototype, 'rowGroups', {
        get: function () {
          if (this._m_rowGroups !== undefined) return this._m_rowGroups;
          if (this.isDataPage) {
            this._m_rowGroups = [];
      ...
      Object.defineProperty(Page.prototype, 'heapPos', {
        get: function () {
          if (this._m_heapPos !== undefined) return this._m_heapPos;
      ...
      Object.defineProperty(Page.prototype, 'isDataPage', {
        get: function () {
          if (this._m_isDataPage !== undefined) return this._m_isDataPage;
    ...
    var RowGroup = (RekordboxPdb.RowGroup = (function () {
      ...
      Object.defineProperty(RowGroup.prototype, 'base', {
        get: function () {
          if (this._m_base !== undefined) return this._m_base;
      ...
      Object.defineProperty(RowGroup.prototype, 'rowPresentFlags', {
        get: function () {
          if (this._m_rowPresentFlags !== undefined) return this._m_rowPresentFlags;
          var _pos = this._io.pos;
      ...
      Object.defineProperty(RowGroup.prototype, 'rows', {
        get: function () {
          if (this._m_rows !== undefined) return this._m_rows;
          this._m_rows = [];
          for (
            var i = 0;
            i <
            (this.groupIndex < this._parent.numGroups - 1
              ? 16
              : KaitaiStream.mod(this._parent.numRows - 1, 16) + 1);
            i++
          ) {
    ...
    var ArtistRow = (RekordboxPdb.ArtistRow = (function () {
      ...
      Object.defineProperty(ArtistRow.prototype, 'ofsNameFar', {
        get: function () {
          if (this._m_ofsNameFar !== undefined) return this._m_ofsNameFar;
          if (this.subtype == 100) {
            var _pos = this._io.pos;
      ...
      Object.defineProperty(ArtistRow.prototype, 'name', {
        get: function () {
          ...
          var _pos = this._io.pos;
          this._io.seek(
            this._parent.rowBase +
              (this.subtype == 100 ? this.ofsNameFar : this.ofsNameNear)
          );
          this._m_name = new DeviceSqlString(this._io, this, this._root);
          this._io.seek(_pos);
          return this._m_name;
    ...
    var TrackRow = (RekordboxPdb.TrackRow = (function () {
      ...
      Object.defineProperty(TrackRow.prototype, 'unknownString8', {
        get: function () {
          if (this._m_unknownString8 !== undefined) return this._m_unknownString8;
          var _pos = this._io.pos;
      ...
      Object.defineProperty(TrackRow.prototype, 'unknownString6', {
        get: function () {
          if (this._m_unknownString6 !== undefined) return this._m_unknownString6;
          var _pos = this._io.pos;
      ...
      Object.defineProperty(TrackRow.prototype, 'analyzeDate', {
        get: function () {
          if (this._m_analyzeDate !== undefined) return this._m_analyzeDate;
          var _pos = this._io.pos;
      ...
      Object.defineProperty(TrackRow.prototype, 'filePath', {
        get: function () {
          if (this._m_filePath !== undefined) return this._m_filePath;
          var _pos = this._io.pos;
      ...
      Object.defineProperty(TrackRow.prototype, 'autoloadHotcues', {
        get: function () {
          if (this._m_autoloadHotcues !== undefined) return this._m_autoloadHotcues;
          var _pos = this._io.pos;
      ...
      Object.defineProperty(TrackRow.prototype, 'dateAdded', {
        get: function () {
          if (this._m_dateAdded !== undefined) return this._m_dateAdded;
          var _pos = this._io.pos;
      ...
      Object.defineProperty(TrackRow.prototype, 'unknownString3', {
        get: function () {
          if (this._m_unknownString3 !== undefined) return this._m_unknownString3;
          var _pos = this._io.pos;
      ...
      Object.defineProperty(TrackRow.prototype, 'texter', {
        get: function () {
          if (this._m_texter !== undefined) return this._m_texter;
          var _pos = this._io.pos;
      ...
      Object.defineProperty(TrackRow.prototype, 'kuvoPublic', {
        get: function () {
          if (this._m_kuvoPublic !== undefined) return this._m_kuvoPublic;
          var _pos = this._io.pos;
      ...
      Object.defineProperty(TrackRow.prototype, 'mixName', {
        get: function () {
          if (this._m_mixName !== undefined) return this._m_mixName;
          var _pos = this._io.pos;
      ...
      Object.defineProperty(TrackRow.prototype, 'unknownString5', {
        get: function () {
          if (this._m_unknownString5 !== undefined) return this._m_unknownString5;
          var _pos = this._io.pos;
      ...
      Object.defineProperty(TrackRow.prototype, 'unknownString4', {
        get: function () {
          if (this._m_unknownString4 !== undefined) return this._m_unknownString4;
          var _pos = this._io.pos;
      ...
      Object.defineProperty(TrackRow.prototype, 'message', {
        get: function () {
          if (this._m_message !== undefined) return this._m_message;
          var _pos = this._io.pos;
      ...
      Object.defineProperty(TrackRow.prototype, 'unknownString2', {
        get: function () {
          if (this._m_unknownString2 !== undefined) return this._m_unknownString2;
          var _pos = this._io.pos;
      ...
      Object.defineProperty(TrackRow.prototype, 'isrc', {
        get: function () {
          if (this._m_isrc !== undefined) return this._m_isrc;
          var _pos = this._io.pos;
      ...
      Object.defineProperty(TrackRow.prototype, 'unknownString7', {
        get: function () {
          if (this._m_unknownString7 !== undefined) return this._m_unknownString7;
          var _pos = this._io.pos;
      ...
      Object.defineProperty(TrackRow.prototype, 'filename', {
        get: function () {
          if (this._m_filename !== undefined) return this._m_filename;
          var _pos = this._io.pos;
      ...
      Object.defineProperty(TrackRow.prototype, 'analyzePath', {
        get: function () {
          if (this._m_analyzePath !== undefined) return this._m_analyzePath;
          var _pos = this._io.pos;
      ...
      Object.defineProperty(TrackRow.prototype, 'comment', {
        get: function () {
          if (this._m_comment !== undefined) return this._m_comment;
          var _pos = this._io.pos;
      ...
      Object.defineProperty(TrackRow.prototype, 'releaseDate', {
        get: function () {
          if (this._m_releaseDate !== undefined) return this._m_releaseDate;
          var _pos = this._io.pos;
      ...
      Object.defineProperty(TrackRow.prototype, 'title', {
        get: function () {
          if (this._m_title !== undefined) return this._m_title;
          var _pos = this._io.pos;
    ...
    var DeviceSqlLongUtf16le = (RekordboxPdb.DeviceSqlLongUtf16le = (function () {
      ...
      DeviceSqlLongUtf16le.prototype._read = function () {
        ...
        this.text = KaitaiStream.bytesToStr(
          this._io.readBytes(this.length - 4),
          'utf-16le'
        );
      };
    ...
    var RowRef = (RekordboxPdb.RowRef = (function () {
      ...
      Object.defineProperty(RowRef.prototype, 'ofsRow', {
        get: function () {
          if (this._m_ofsRow !== undefined) return this._m_ofsRow;
          var _pos = this._io.pos;
      ...
      Object.defineProperty(RowRef.prototype, 'rowBase', {
        get: function () {
          if (this._m_rowBase !== undefined) return this._m_rowBase;
      ...
      Object.defineProperty(RowRef.prototype, 'present', {
        get: function () {
          if (this._m_present !== undefined) return this._m_present;
          this._m_present =
            ((this._parent.rowPresentFlags >>> this.rowIndex) & 1) != 0 ? true : false;
